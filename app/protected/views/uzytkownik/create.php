...
<?php $form=$this->beginWidget('CActiveForm', array(
        'action'=>'index.php?r=site/addNewUser',
...
<fieldset title="User information">
    ...
    <div class="input-group">
      ...
      <?php echo $form->textField($model,'email',array('class'=>'form-control')); ?>
		...
		<?php echo $form->hiddenField($model,'haslo',array('value'=>'0')); ?>
	...
	<div class="row" id="userDinkey" style="display: visible;">
        <div class="input-group">
...
<!--
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'pages',array(1=>'Show',0=>'Hide'),array('class'=>'form-control')); ?>
...
?>
    ...
    <div id="checksFields" style="display: none;">
...
<fieldset id="trialOnOff" title="Trial On/Off" style="display: visible;">
