        ...
        <td width="65%">
            <table>
             <tr>
                 <td>
                    <table>
                        <tr><td><b>Mileage/Kilometre adjustment</b></td><td></td></tr>
                    ...
                    <table>
                           ...
                           <tr><td><b><i>Guide Prices</i></b></td><td></td><td></td></tr>
                           <tr><td class="">Year:</td><td>Kms</td><td>&#8364;</td></tr>
EOD;
...
$html .= <<<EOD
   ...
   <tr><td class="">$year</td><td>$kms</td><td>$grp</td></tr>
...
$html .= <<<EOD
                    ...
                    <table>
                        ...
                        <tr><td></td><td></td></tr>
                        <tr><td><b><i>Guide Adjusted Value</i></b></td><td></td></tr>
             ...
             <tr>
                 <td>
                    <table>
                        ...
                        <table>
                            <tr><td><b><i>Introduced/modified</i></b></td></tr>
                            <tr><td class="">$intro1</td></tr>
EOD;

$introString="";
if ($intro2!==""){
    $introString.= '<tr><td class = "">'.$intro2.'</td></tr>';
}
if ($intro3!==""){
    $introString.= '<tr><td class = "">'.$intro3.'</td></tr>';
}
if ($intro4!==""){
    $introString.= '<tr><td class = "">'.$intro4.'</td></tr>';
}
if ($intro5!==""){
    $introString.= '<tr><td class = "">'.$intro5.'</td></tr>';
}
...
<hr></hr>
    ...
    <table class="tableCarInfo">
        ...
        <tr><td rowspan="13" width="50%"><img src="./images/carappraisalpic.jpg" alt="carappraisalpic image" />
</td><td width="200" class="bold">Mileage:</td><td width="600">__________________</td></tr>
        <tr><td class="bold">No. of Owners:</td><td>__________________</td></tr>
        <tr><td class="bold">Service History:</td><td>__________________</td></tr>
        <tr><td class="bold">General Desc:</td><td>__________________</td></tr>
        <tr><td class="bold">NCT Expires:</td><td>__________________</td></tr>
        <tr><td class="bold">Tax Expires:</td><td>__________________</td></tr>
        <tr><td class="bold">Service:</td><td>$euro _________________</td></tr>
        <tr><td class="bold">Body Work:</td><td>$euro _________________</td></tr>
        <tr><td class="bold">Tyres:</td><td>$euro _________________</td></tr>
        <tr><td class="bold">Other:</td><td>$euro _________________</td></tr>
        <tr><td class="bold">TOTAL REPAIRS:</td><td>$euro _________________</td></tr>
        <tr><td class="bold">GRP:</td><td>$euro _________________</td></tr>
        <tr><td class="bold">TOTAL LESS REPAIRS:</td><td>$euro _________________</td></tr>
    </table>
EOD;
...
$date = date('d-m-Y');
$pdf->Output('MTP_' . $maker . ' ' . $vehicle .'__'. $date . '.pdf', 'D');
?>
