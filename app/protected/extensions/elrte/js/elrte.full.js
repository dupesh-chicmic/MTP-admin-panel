...
elRTE.prototype.options   = {
	...
	toolbars    : {
		...
		eldorado : ['save', 'copypaste', 'elfinder', 'undoredo', 'style', 'alignment', 'colors', 'format', 'indent', 'lists', 'links', 'elements', 'media', 'tables', 'fullscreen'],
                melon    : ['save', 'undoredo', 'style', 'alignment', 'colors', 'indent', 'lists',],
                qcms     : ['save', 'copypaste', 'undoredo', 'elfinder', 'style', 'alignment', 'direction', 'colors', 'format', 'indent', 'lists', 'links', 'elements', 'media', 'fullscreen']
