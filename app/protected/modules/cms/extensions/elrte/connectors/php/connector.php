...
//var_dump($_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'pictures/client/');

// !!!!!! elementy uniwersalne uzywaja elrte z glownej aplikacji
// strony w cms z modulu
// popraw oba !!


$opts = array(
'root'            => $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'pictures/client/',  // path to root directory
'URL'             => 'pictures/client/', // root directory URL

//$opts = array(
//	'root'            => $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.''.$this_page[1].'/pictures/client/',  // path to root directory
//	'URL'             => '/'.$this_page[1].'/photo/client/', // root directory URL
