...
$this->breadcrumbs=array(
	...
	//$model->uzytkownik->login=>array('viewEmployee','id'=>$model->racownik->id_uzytkownika),
	'Aktualizacja danych',
);
$menu_admin=array();
...
<h1>Aktualizacja danych firmy: <?php echo $model->getName(); ?></h1>

<?php echo $this->renderPartial('_formCompany', array('model'=>$model)); ?>