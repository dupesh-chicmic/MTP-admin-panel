...
class WebUser extends CApplicationComponent implements IWebUser
{
	...
	public function login($identity,$duration=0)
	{
		...
		if($duration>0)
		{
			if($this->allowAutoLogin)
                ...
                Yii::app()->user->getModel()->uzytkownik->sid=Yii::app()->getSession()->sessionID;
                //Yii::app()->user->getModel()->uzytkownik->saveAttributes(array('sid')); //TODO sprawdzic !
	...
	{
            //TODO: to jest jakieś dziwne, gdzie jest hasOutdatedSession?
        ...
        public function getModel()
        {
            if(!$this->_model)
            {
                ...
                elseif($this->getIsCustomer())
                    {
                        $this->_model=Klient::model()->with('uzytkownik')->findByPk($this->id);
                    }
                    else return null;
            }
  ...
  public function getCompany(){
        ...
        public function getCustomer()
        {
            ...
            if(($this->getState('as_klient_uzytkownik'))!=null)
            {
                $this->_customer=Klient::model()->with('uzytkownik')->findByPk($this->getState('as_klient_uzytkownik'));
                return $this->_customer;
            }
