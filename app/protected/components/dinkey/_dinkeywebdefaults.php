...
class DinkeyWebParams
{
    ...
    var $M_SDSN         = 12175;                // Your SDSN
    var $M_DongleType   = DONGLETYPE_BOTH;     // Must be one of the DONGLETYPE_xxx values defined above
    ...
    var $DP_Flags               = 0;                // Bitwise-OR of the DinkeyPro/DinkeyFD flags shown above
    ...
    var $M_LibrariesURL = "http://mtp.ie/test/dinkey/libs/protected";
    var $M_ErrorPageURL = "http://mtp.ie/test/index.php?r=member/dinkeyError";
