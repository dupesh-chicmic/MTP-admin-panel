...
class Import extends CActiveRecord
{
    ...
    public function read_dir_and_create_query($dir, $tableName, $tableName_model, $modelName, $id_import)
    {
        ...
        while (($file = readdir($dh)) !== false) {
            if ($file !== '.' && $file !== '..' && $file !== '.svn' && $file !== 'man.xml' && $file !== '.DS_Store' && substr($file, strlen($file) - 4, 4) !== '.zip') {
                ...
                foreach ($cars->model as $row) {
                    ...
                    for ($i = 0; $i < 17; $i++) {
                        ...
                        $values .= '"' . $row['kms' . $i] . '",';
                        $values .= '"' . $row['GRP' . $i] . '",';
                        $values .= '"' . $row['newprice' . $i] . '",'; //newly added by yasir on 29-02-2024 as requested by client on email
                    }
                    ...
                    if (isset($row['rangecode'])) {
                        ...
                        $nazwyPolDoInsertu = ' ' . $lvIdUsedCarsOrCom . ', codenumber, maker, vehicle, badge, body, price, years, fuel, yr0, kms0, GRP0, newprice0, yr1, kms1, GRP1, newprice1, yr2, kms2, GRP2, newprice2, yr3, kms3, GRP3, newprice3, yr4, kms4, GRP4, newprice4, yr5, kms5, GRP5, newprice5, yr6, kms6, GRP6, newprice6, yr7, kms7, GRP7, newprice7, yr8, kms8, GRP8, newprice8, yr9, kms9, GRP9, newprice9, yr10, kms10, GRP10, newprice10, yr11, kms11, GRP11, newprice11, yr12, kms12, GRP12, newprice12, yr13, kms13, GRP13, newprice13, yr14, kms14, GRP14, newprice14, yr15, kms15, GRP15, newprice15, yr16, kms16, GRP16, newprice16, spec1, spec2, spec3, spec4, spec, intro1, intro2, intro3, intro4, intro5, note1, note2, note3, note4, note5, corecode, rge, mdl, bod, drs, notenum, badgetype, transmission, linkas, rangecode, cc, drive,';
                    } else {
                        $values .= '"' . $row['LinkAs'] . '",';

                        $nazwyPolDoInsertu = ' ' . $lvIdUsedCarsOrCom . ', codenumber, maker, vehicle, badge, body, price, years, fuel, yr0, kms0, GRP0, newprice0, yr1, kms1, GRP1, newprice1, yr2, kms2, GRP2, newprice2, yr3, kms3, GRP3, newprice3, yr4, kms4, GRP4, newprice4, yr5, kms5, GRP5, newprice5, yr6, kms6, GRP6, newprice6, yr7, kms7, GRP7, newprice7, yr8, kms8, GRP8, newprice8, yr9, kms9, GRP9, newprice9, yr10, kms10, GRP10, newprice10, yr11, kms11, GRP11, newprice11, yr12, kms12, GRP12, newprice12, yr13, kms13, GRP13, newprice13, yr14, kms14, GRP14, newprice14, yr15, kms15, GRP15, newprice15, yr16, kms16, GRP16, newprice16, spec1, spec2, spec3, spec4, spec, intro1, intro2, intro3, intro4, intro5, note1, note2, note3, note4, note5, corecode, rge, mdl, bod, drs, notenum, badgetype, transmission, linkas, cc, drive,';
                    }
                    for ($i = 1; $i <= 18; $i++) {
                    ...
                    if (isset($row['varient_id']) && !empty($row['varient_id'])) {
                        $nazwyPolDoInsertu .= ' varient_id,';
                    }
    ...
    function export_petrolDieselBand_xml_to_db($tableName, $petrolDieselXmlFile, $id_import)
    {
        ...
        foreach ($kms->bands as $row) {
            ...
            $nazwyPolDoInsertu = 'id_import, fromXml, toXml, yr1, yr2, yr3, yr4, yr5, yr6, yr7, yr8, yr9, yr10, yr11, yr12, yr13, yr14, yr15, yr16, yr17, yr18';
    ...
    public static function getLastImportId()
    {
