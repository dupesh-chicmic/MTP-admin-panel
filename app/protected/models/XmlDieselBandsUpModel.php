...
/**
 * This is the model class for table "xml_diesel_bands_up_model".
 *
 * The followings are the available columns in table 'xml_diesel_bands_up_model':
 * @property integer $id
 ...
 */
class XmlDieselBandsUpModel extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return XmlDieselBandsUpModel the static model class
	 */
	...
	{
		return 'xml_diesel_bands_up_model';
	}
