...
/**
 * This is the model class for table "used_comms_ranges".
 *
 * The followings are the available columns in table 'used_comms_ranges':
 * @property integer $id
 ...
 */
class UsedCommsRanges extends CActiveRecord
{
	/**
...
public static function getUsedCommsRanges($importId)
	{
		//RANGES:
            $useCarsRanges = UsedCommsRanges::model()->findAll('id_import=:id_import', array('id_import'=>$importId));
...
//                
	 ...
	 * @return UsedCommsRanges the static model class
	 */
