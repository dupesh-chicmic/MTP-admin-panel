...
/**
 * This is the model class for table "xml_ucomms_links".
 *
 * The followings are the available columns in table 'xml_ucomms_links':
 * @property integer $id
 ...
 */
class XmlUcommsLinks extends CActiveRecord
{
	/**
	 ...
	 * @return XmlUcommsLinks the static model class
	 */
