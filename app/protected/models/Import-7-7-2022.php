...
//                    Yii::app()->db->createCommand('TRUNCATE TABLE '.$tableName_model_db.' ')->execute();
                ...
                foreach ($cars->model as $row)
                {
                   ...
                   // $values .= '"'.$row['LinkAs'].'",';    
                    ...
                    if(isset($row['rangecode'])){
                        ...
                        $nazwyPolDoInsertu = ' '.$lvIdUsedCarsOrCom.', codenumber, maker, vehicle, badge, body, price, years, fuel, yr0, kms0, GRP0, yr1, kms1, GRP1, yr2, kms2, GRP2, yr3, kms3, GRP3, yr4, kms4, GRP4, yr5, kms5, GRP5, yr6, kms6, GRP6, yr7, kms7, GRP7, yr8, kms8, GRP8, yr9, kms9, GRP9, yr10, kms10, GRP10, yr11, kms11, GRP11, yr12, kms12, GRP12, yr13, kms13, GRP13, yr14, kms14, GRP14, yr15, kms15, GRP15, yr16, kms16, GRP16, spec1, spec2, spec3, spec4, spec, intro1, intro2, intro3, intro4, intro5, note1, note2, note3, note4, note5, corecode, rge, mdl, bod, drs, notenum, badgetype, transmission, linkas, rangecode, cc, drive,';
                    }else {
                        $values .= '"'.$row['LinkAs'].'",';   
                        
                        $nazwyPolDoInsertu = ' '.$lvIdUsedCarsOrCom.', codenumber, maker, vehicle, badge, body, price, years, fuel, yr0, kms0, GRP0, yr1, kms1, GRP1, yr2, kms2, GRP2, yr3, kms3, GRP3, yr4, kms4, GRP4, yr5, kms5, GRP5, yr6, kms6, GRP6, yr7, kms7, GRP7, yr8, kms8, GRP8, yr9, kms9, GRP9, yr10, kms10, GRP10, yr11, kms11, GRP11, yr12, kms12, GRP12, yr13, kms13, GRP13, yr14, kms14, GRP14, yr15, kms15, GRP15, yr16, kms16, GRP16, spec1, spec2, spec3, spec4, spec, intro1, intro2, intro3, intro4, intro5, note1, note2, note3, note4, note5, corecode, rge, mdl, bod, drs, notenum, badgetype, transmission, linkas, cc, drive,';
    ...
    function export_petrolDieselBand_xml_to_db($tableName, $petrolDieselXmlFile, $id_import)
    {
        ...
        foreach ($kms->bands as $row)
        {
            ...
            $nazwyPolDoInsertu = 'id_import, fromXml, toXml, yr1, yr2, yr3, yr4, yr5, yr6, yr7, yr8, yr9, yr10, yr11, yr12, yr13, yr14, yr15, yr16, yr17';
