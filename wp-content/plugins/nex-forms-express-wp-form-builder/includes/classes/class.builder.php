	...
	/*** Label text color ***/
							...
							$output .= '<div class="field-setting col-xs-4 s-all">';
								$output .= '<div role="group" class="btn-group overall-error-style ">';
									...
									$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf modern '.(($overall_field_errors == 'modern' || !$overall_field_errors) ? 'active': '').'" type="button" data-style-tool="modern"  title="Modern"><i class="fa fa-warning"></i></button>';
...
//VALIDATION SETTINGS //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
	...
	/*** Required ***/	
								...
								$output .= '<div role="group" class="btn-group error-style">';
									...
									$output .= '<button class="btn btn-default waves-effect-nf waves-light-nf modern  active" type="button" data-style-tool="modern"  title="Modern"><i class="fa fa-warning"></i></button>';
...
$output .= '<div class="inner-form-canvas">';
	...
	$output .= '</div>';
			...
			$output .= '
			'.(($theme->Name=='NEX-Forms Demo') ? '<!--<a href="http://codecanyon.net/item/nexforms-the-ultimate-wordpress-form-builder/7103891?license=regular&open_purchase_for_item_id=7103891&purchasable=source&ref=Basix" target="_blank"  style="padding:7px !important;" class="btn waves-effect-nf waves-light-nf upgrade_pro animated fadeInRight">BUY NEX-FORMS</a>-->' : '' ).'
	...
	public function print_integration_setup(){
		...
		$set_code = true;
			...
			echo '<div class="form_attr_wrapper">';
						...
						echo '	<div class="navigation" style="display:none;"><div class="nav-content">
									<ul class="tabs_nf tri-menu">
										<li class="tab show_zapier_setup_menu_item"><a class="active" href="#zapier_integration">'.__('Zapier','nex-forms').'</a></li>
				...
				echo '<div class="form_attr_left_menu aa_bg_sec aa_menu">';
				echo '<ul>';
					echo '<li class="active"><a class="show_zapier_setup"><span class="fa fa-asterisk"></span> <span class="sidemenu_text">'.__('Zapier','nex-forms').'</span></a></li>';
