...
<a href="#so">Show only a part of the iframe or modify it</a>
    ...
    ?> 
     <tr>
        <th scope="row"><strong><?php _e('Browser detection', 'advanced-iframe'); ?></strong>
          ...
          <?php _e('You can now specify browser specific iframes. This is imporant especially for the "Show only part of the iframe" feature where browser differences of a few pixels can matter. But you can use this for other things as well because mobile, iphone, ipad can also be detected. Please read the <a id="browser-detection-link" href="#browser-detection">browser detection</a> section for details. Shortcode: browser=""', 'advanced-iframe'); ?></td>
    </tr>    
    </table>
