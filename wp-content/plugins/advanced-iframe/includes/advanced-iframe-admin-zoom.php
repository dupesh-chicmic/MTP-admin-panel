...
<div>
    ...
    <p>
<?php _e('All major browsers do now support the zoom of iframes. Depending on your setup you can use a static zoom factor or even automatic zoom.', 'advanced-iframe');
