...
var domain_advanced_iframe = 'https://mtp.ie'; // Check if this is your wordpress root
...
if (doIt) {
  ...
  window.jQuery || document.write("<script src='http://mtp.ie/wp-includes/js/jquery/jquery.js'></script>");
  
  // load the resize script if needed.
  if (resize_on_element_resize != '') {
      document.write("<script src='http://mtp.ie/wp-content/plugins/advanced-iframe/includes/scripts/jquery.ba-resize.min.js'></script>");
  }
