/**
 *  Advanced iframe pro external workaround file v6.5 - Standalone version
 *  Created: 2015-07-16 22:07:53 
*/ 
...
if (typeof domain_advanced_iframe === 'undefined') { // Wordpress
    alert("Please set domain_advanced_iframe_path before you include the external Workaround file.");
} else { // Standalone. domain_advanced_iframe is set
    var domain_advanced_iframe_path = '';
}
...
if (resize_on_element_resize != '') {
    document.write("<script src='"+domain_advanced_iframe+"/includes/scripts/jquery.ba-resize.min.js'></script>");
}
